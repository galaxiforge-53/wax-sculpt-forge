    ...
    <div className="min-h-screen bg-background px-4 sm:px-6 py-10 sm:py-16">
      <div className="max-w-4xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <h1 className="font-display text-2xl sm:text-3xl md:text-4xl mb-2">Templates</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
          {TEMPLATE_REGISTRY.map((t, i) => (
            <motion.button
              ...
              className="text-left p-4 sm:p-5 rounded-xl border border-border bg-card hover:border-primary/40 transition-all group"
            >
              <span className="text-xl sm:text-2xl mb-2 block">{t.icon}</span>

...
function RingMesh({ params, viewMode, metalPreset }: RingMeshProps) {
  const geometry = useMemo(() => {
    const innerRadius = params.innerDiameter / 2 / 10; // convert mm to scene units
    const outerRadius = innerRadius + params.thickness / 10;
    const width = params.width / 10;

    // Create ring cross-section profile
...
export default function RingViewport({ params, viewMode, metalPreset }: RingViewportProps) {
  return (
